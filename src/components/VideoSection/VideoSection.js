    ...
    return (
        ...
        <div className="video">
            {/*MAIN BLOCK*/}
                ...
                USYK vs. JOSHUA 2\" allowFullScreen/>
                        <div className="video__block-header-main">
                            <div className="video__block-date">05 серпня 11:00</div>
                            <div className="video__block-description">"Це не Джошуа": Усик розповів, кого вважає своїм
                                головним
                                суперником
                            </div>
                        </div>
                ...
                <div className="video__container">
                    ...
                    <div className="video__block">
                        ...
                        <iframe className={'video__video'} width={304} height={171} src="https://www.youtube.com/embed/y3j3WssE_TQ"
                                title="Ватажок Пушилін вимагає від ЗСУ покинути Донецьку область" frameBorder="0"
